...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Search - AniList-Node Documentation</title>
		...
		<div id="main">
			...
			<section>
				<header>
					...
					<div class="class-description usertext">Search for items on AniList</div>
				</header>
				...
				<article>
					...
					<h4 class="name" id="activity">
						<span class="type-signature"></span>activity<span class="signature"
							>(activityID, filter, page, amount)</span
						><span class="type-signature">
							&rarr; {<a href="global.html#ActivityEntry">ActivityEntry</a>}</span
						>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Search for a specific activity</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="search.js.html">search.js</a>,
									<a href="search.js.html#line208">line 208</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								<td class="name"><code>activityID</code></td>
							...
							<tr>
								...
								<td class="description last">A key-value paired object to filter search data.</td>
							</tr>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#ActivityEntry">ActivityEntry</a></span>
						</dd>
					</dl>

					<h4 class="name" id="anime">
						<span class="type-signature"></span>anime<span class="signature"
							>(term, filter, page, amount)</span
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Search for a specific anime</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="search.js.html">search.js</a>,
									<a href="search.js.html#line156">line 156</a>
								</li>
							</ul>
						</dd>
					...
					<h4 class="name" id="character">
						<span class="type-signature"></span>character<span class="signature">(term, page, amount)</span
						><span class="type-signature"> &rarr; {<a href="global.html#SearchEntry">SearchEntry</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Search for a specific character</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">
									Required. The term to lookup. (ie: "Myne" or "Chise Hatori")
								</td>
							</tr>
					...
					<h4 class="name" id="manga">
						<span class="type-signature"></span>manga<span class="signature"
							>(term, filter, page, amount)</span
						><span class="type-signature"> &rarr; {<a href="global.html#SearchEntry">SearchEntry</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Search for a specific manga</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="search.js.html">search.js</a>,
									<a href="search.js.html#line182">line 182</a>
								</li>
							</ul>
						</dd>
					...
					<h4 class="name" id="staff">
						<span class="type-signature"></span>staff<span class="signature">(term, page, amount)</span
						><span class="type-signature"> &rarr; {<a href="global.html#SearchEntry">SearchEntry</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Search for a specific staff member</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="search.js.html">search.js</a>, <a href="search.js.html#line91">line 91</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">Required. The term to lookup. (ie: "Yuka Iguchi")</td>
							</tr>
					...
					<h4 class="name" id="studio">
						<span class="type-signature"></span>studio<span class="signature">(term, page, amount)</span
						><span class="type-signature"> &rarr; {<a href="global.html#SearchEntry">SearchEntry</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Search for a specific studio</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="search.js.html">search.js</a>, <a href="search.js.html#line59">line 59</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">Required. The term to lookup. (ie: "White Fox")</td>
							</tr>
					...
					<h4 class="name" id="user">
						<span class="type-signature"></span>user<span class="signature">(term, page, amount)</span
						><span class="type-signature"> &rarr; {<a href="global.html#SearchEntry">SearchEntry</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="search.js.html">search.js</a>,
									<a href="search.js.html#line123">line 123</a>
								</li>
							</ul>
						</dd>
