...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Thread - AniList-Node Documentation</title>
		...
		<div id="main">
			...
			<section>
				<header>
					...
					<div class="class-description usertext">Access threads on AniList</div>
				</header>
				...
				<article>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>[Require Login] Delete a thread</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="thread.js.html">thread.js</a>, <a href="thread.js.html#line50">line 50</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">The AniList thread ID to delete</td>
							</tr>
						</tbody>
					</table>
					...
					<h4 class="name" id="get">
						<span class="type-signature"></span>get<span class="signature">(id)</span
						><span class="type-signature"> &rarr; {<a href="global.html#ThreadEntry">ThreadEntry</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Get a specific thread by its AniList ID</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="thread.js.html">thread.js</a>, <a href="thread.js.html#line24">line 24</a>
								</li>
							</ul>
						</dd>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#ThreadEntry">ThreadEntry</a></span>
						</dd>
					</dl>

					<h4 class="name" id="getComments">
						<span class="type-signature"></span>getComments<span class="signature">(id, page, perPage)</span
						><span class="type-signature">
							&rarr; {Array.&lt;<a href="global.html#ThreadComment">ThreadComment</a>>}</span
						>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Get thread comments for a thread</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="thread.js.html">thread.js</a>, <a href="thread.js.html#line69">line 69</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">The AniList thread ID</td>
							</tr>
							...
							<tr>
								...
								<td class="description last">How many entries per page</td>
							</tr>
						</tbody>
					</table>
