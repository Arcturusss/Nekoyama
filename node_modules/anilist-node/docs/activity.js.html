...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>activity.js - AniList-Node Documentation</title>
	...
	<body>
		...
		<div id="main">
			<h1 class="page-title">activity.js</h1>

			<section>
				<article>
					<pre
						class="prettyprint source linenums"
					><code>const { TextActivityQuery, MessageActivityQuery, ListActivityQuery } = require("./consts");
