...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Media - AniList-Node Documentation</title>
		...
		<div id="main">
			...
			<section>
				<header>
					...
					<div class="class-description usertext">Access AniList's media data.</div>
				</header>
				...
				<article>
					...
					<h4 class="name" id="anime">
						<span class="type-signature"></span>anime<span class="signature">(id)</span
						><span class="type-signature"> &rarr; {<a href="global.html#AnimeEntry">AnimeEntry</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch an anime entry by its AniList ID.</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="media.js.html">media.js</a>, <a href="media.js.html#line23">line 23</a>
								</li>
							</ul>
						</dd>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#AnimeEntry">AnimeEntry</a></span>
						</dd>
					</dl>

					<h4 class="name" id="favouriteAnime">
						<span class="type-signature type-signature-async">(async) </span>favouriteAnime<span
							class="signature"
							>(id)</span
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>[Requires Login] Favourite/Unfavourite an anime</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="media.js.html">media.js</a>, <a href="media.js.html#line55">line 55</a>
								</li>
							</ul>
						</dd>
					...
					<h4 class="name" id="favouriteManga">
						<span class="type-signature type-signature-async">(async) </span>favouriteManga<span
							class="signature"
							>(id)</span
						><span class="type-signature"> &rarr; {Boolean}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>[Requires Login] Favourite/Unfavourite a manga</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="media.js.html">media.js</a>, <a href="media.js.html#line110">line 110</a>
								</li>
							</ul>
						</dd>
					...
					<h4 class="name" id="manga">
						<span class="type-signature"></span>manga<span class="signature">(id)</span
						><span class="type-signature"> &rarr; {<a href="global.html#MangaEntry">MangaEntry</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch a manga entry by its AniList ID.</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="media.js.html">media.js</a>, <a href="media.js.html#line82">line 82</a>
								</li>
							</ul>
						</dd>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#MangaEntry">MangaEntry</a></span>
						</dd>
					</dl>
				</article>
			</section>
