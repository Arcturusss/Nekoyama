...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>User - AniList-Node Documentation</title>
	...
	<body>
		...
		<div id="main">
			...
			<section>
				<header>
					<h2>
						<span class="ancestors"><a href="AniList.html">AniList</a>.</span>

						User
					</h2>

					<div class="class-description usertext">Access AniList's user data.</div>
				</header>
				...
				<article>
					...
					<h4 class="name" id="all">
						<span class="type-signature"></span>all<span class="signature">(user)</span
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch a user's AniList profile, basic and stats.</li>
							</ul>
						</dd>
					...
					<div class="param-desc">
						Returns all keys within <a href="global.html#UserProfile">UserProfile</a> and
						<a href="global.html#UserStats">UserStats</a>. UserStats are found under the statistics key.
					</div>
					...
					<h4 class="name" id="follow">
						<span class="type-signature type-signature-async">(async) </span>follow<span class="signature"
							>(userID)</span
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>[Requires Login] Follow/Unfollow a user</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li><a href="user.js.html">user.js</a>, <a href="user.js.html#line122">line 122</a></li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">The user ID of the account to follow</td>
							</tr>
						</tbody>
					</table>
					...
					<div class="param-desc">True if following, false otherwise.</div>
					...
					<h4 class="name" id="getAuthorized">
						<span class="type-signature"></span>getAuthorized<span class="signature">()</span
						><span class="type-signature"> &rarr; {<a href="global.html#UserProfile">UserProfile</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch profile information on the currently authorized user.</li>
							</ul>
						</dd>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#UserProfile">UserProfile</a></span>
						</dd>
					</dl>

					<h4 class="name" id="getRecentActivity">
						<span class="type-signature"></span>getRecentActivity<span class="signature">(user)</span
						><span class="type-signature"> &rarr; {Array.&lt;Object>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch recent activity from a user.</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">Required. Needs to be the user's AniList ID.</td>
							</tr>
						</tbody>
					</table>
					...
					<div class="param-desc">
						Returns the 25 most recent activities of the user. Contains any number of
						<a href="global.html#ListActivity">ListActivity</a>,
						<a href="global.html#TextActivity">TextActivity</a>,
						<a href="global.html#MessageActivity">MessageActivity</a>. All of which are identifyable by the
						type key.
					</div>
					...
					<h4 class="name" id="profile">
						<span class="type-signature"></span>profile<span class="signature">(user)</span
						><span class="type-signature"> &rarr; {<a href="global.html#UserProfile">UserProfile</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch a user's AniList basic profile.</li>
							</ul>
						</dd>
					...
					<h4 class="name" id="stats">
						<span class="type-signature"></span>stats<span class="signature">(user)</span
						><span class="type-signature"> &rarr; {<a href="global.html#UserStats">UserStats</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch a user's AniList stats.</li>
							</ul>
						</dd>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#UserStats">UserStats</a></span>
						</dd>
					</dl>

					<h4 class="name" id="update">
						<span class="type-signature type-signature-async">(async) </span>update<span class="signature"
							>(options)</span
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>[Requires Login] Update user settings</li>
							</ul>
						</dd>
							...
							<tr>
								...
								<td class="type">
									<span class="param-type"
										><a href="global.html#UserOptionsInput">UserOptionsInput</a></span
									>
								</td>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#UserOptions">UserOptions</a></span>
						</dd>
					</dl>
				</article>
			</section>
