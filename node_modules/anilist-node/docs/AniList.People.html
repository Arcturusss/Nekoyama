...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>People - AniList-Node Documentation</title>
		...
		<div id="main">
			...
			<section>
				<header>
					...
					<div class="class-description usertext">Access AniList's characters and staff data.</div>
				</header>

				<article>
					<h3 class="subsection-title">Methods</h3>

					<h4 class="name" id="character">
						<span class="type-signature"></span>character<span class="signature">(id)</span
						><span class="type-signature">
							&rarr; {<a href="global.html#CharacterEntry">CharacterEntry</a>}</span
						>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch a character entry by its AniList ID.</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="people.js.html">people.js</a>, <a href="people.js.html#line23">line 23</a>
								</li>
							</ul>
						</dd>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#CharacterEntry">CharacterEntry</a></span>
						</dd>
					</dl>

					<h4 class="name" id="favouriteChar">
						<span class="type-signature type-signature-async">(async) </span>favouriteChar<span
							class="signature"
							>(id)</span
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>[Requires Login] Favourite/Unfavourite a character</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="people.js.html">people.js</a>, <a href="people.js.html#line42">line 42</a>
								</li>
							</ul>
						</dd>
					...
					<h4 class="name" id="favouriteStaff">
						<span class="type-signature type-signature-async">(async) </span>favouriteStaff<span
							class="signature"
							>(id)</span
						><span class="type-signature"> &rarr; {Boolean}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>[Requires Login] Favourite/Unfavourite a staff entry</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="people.js.html">people.js</a>,
									<a href="people.js.html#line112">line 112</a>
								</li>
							</ul>
						</dd>
					...
					<h4 class="name" id="getBirthdayCharacters">
						<span class="type-signature type-signature-async">(async) </span>getBirthdayCharacters<span
							class="signature"
							>(page)</span
						><span class="type-signature">
							&rarr; {Array.&lt;<a href="global.html#PersonRelation">PersonRelation</a>>}</span
						>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Get all characters who's birthday is today</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="people.js.html">people.js</a>, <a href="people.js.html#line69">line 69</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">What page in the search to target. Defaults at 1.</td>
							</tr>
						</tbody>
					</table>
					...
					<h4 class="name" id="getBirthdayStaff">
						<span class="type-signature type-signature-async">(async) </span>getBirthdayStaff<span
							class="signature"
							>(page)</span
						><span class="type-signature">
							&rarr; {Array.&lt;<a href="global.html#PersonRelation">PersonRelation</a>>}</span
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Get all staff entries who's birthday is today</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="people.js.html">people.js</a>,
									<a href="people.js.html#line139">line 139</a>
								</li>
							</ul>
						</dd>
					...
					<h4 class="name" id="staff">
						<span class="type-signature"></span>staff<span class="signature">(id)</span
						><span class="type-signature"> &rarr; {<a href="global.html#StaffEntry">StaffEntry</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch a staff entry by its AniList ID or their name.</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="people.js.html">people.js</a>, <a href="people.js.html#line91">line 91</a>
								</li>
							</ul>
						</dd>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#StaffEntry">StaffEntry</a></span>
						</dd>
					</dl>
				</article>
			</section>
