...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Lists - AniList-Node Documentation</title>
		...
		<div id="main">
			...
			<section>
				<header>
					...
					<div class="class-description usertext">Access a user's AniList list data.</div>
				</header>

				<article>
					<h3 class="subsection-title">Methods</h3>

					<h4 class="name" id="addEntry">
						<span class="type-signature type-signature-async">(async) </span>addEntry<span class="signature"
							>(id, options)</span
						><span class="type-signature">
							&rarr; {<a href="global.html#UpdatedEntry">UpdatedEntry</a>}</span
						>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>[Requires Login] Add an entry to a user's list.</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="lists.js.html">lists.js</a>, <a href="lists.js.html#line47">line 47</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">The AniList ID of the entry to add</td>
							</tr>
							...
							<tr>
								...
								<td class="type">
									<span class="param-type"
										><a href="global.html#UpdateEntryOptions">UpdateEntryOptions</a></span
									>
								</td>

								<td class="description last">Values to save with.</td>
							</tr>
						</tbody>
					</table>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#UpdatedEntry">UpdatedEntry</a></span>
						</dd>
					</dl>

					<h4 class="name" id="anime">
						<span class="type-signature"></span>anime<span class="signature">(user)</span
						><span class="type-signature"> &rarr; {<a href="global.html#UserList">UserList</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch a user's AniList anime lists.</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="lists.js.html">lists.js</a>, <a href="lists.js.html#line25">line 25</a>
								</li>
							</ul>
						</dd>
					...
					<dl class="param-type">
						<dt>Type</dt>
						<dd>
							<span class="param-type"><a href="global.html#UserList">UserList</a></span>
						</dd>
					</dl>

					<h4 class="name" id="manga">
						<span class="type-signature"></span>manga<span class="signature">(user)</span
						><span class="type-signature"> &rarr; {<a href="global.html#UserList">UserList</a>}</span>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Fetch a user's AniList manga lists.</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="lists.js.html">lists.js</a>, <a href="lists.js.html#line73">line 73</a>
								</li>
							</ul>
						</dd>
					...
					<h4 class="name" id="removeEntry">
						<span class="type-signature type-signature-async">(async) </span>removeEntry<span
							class="signature"
							>(id)</span
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>[Requires Login] Remove an entry from a user's lists.</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="lists.js.html">lists.js</a>, <a href="lists.js.html#line121">line 121</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">The AniList list ID of the entry to remove.</td>
							</tr>
						</tbody>
					</table>
					...
					<div class="param-desc">Returns true if removed, false otherwise.</div>
					...
					<h4 class="name" id="updateEntry">
						<span class="type-signature type-signature-async">(async) </span>updateEntry<span
							class="signature"
							>(id, options)</span
						><span class="type-signature">
							&rarr; {<a href="global.html#UpdatedEntry">UpdatedEntry</a>}</span
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>[Requires Login] Update a list entry to a user's list.</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="lists.js.html">lists.js</a>, <a href="lists.js.html#line95">line 95</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">The AniList list ID of the entry to edit.</td>
							</tr>
