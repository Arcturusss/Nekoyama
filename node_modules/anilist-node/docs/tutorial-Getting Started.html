...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Tutorial: Getting Started - AniList-Node Documentation</title>
		...
		<div id="main">
			...
			<section>
				...
				<article>
					<h2>How to Import</h2>
					<p>
						AniList-Node is a class based, asynchronous package, meaning the main class needed to be
						constructed and all of its methods are async.
					</p>
					<p>For JavaScript, a simple require line and new class is perfect for the job.</p>
					<pre
						class="prettyprint source lang-JavaScript"
					><code>const AniList = require(&quot;anilist-node&quot;);

const anilist = new AniList();
</code></pre>
					<p>
						However with TypeScript installs, the class is exported under the name AniList and therefore
						should be imported as such. AniList-Node is a CommonJS package so depending on your
						configurations, you may need to import it differently.
					</p>
					<pre class="prettyprint source lang-TypeScript"><code>// For projects using CommonJS modules
...
const anilist = new AniList();
					...
					<h2>Authorization</h2>
					<p>
						For a few features such as checking favourites, a token needs to be added to AniList-Node during
						the class initialization.
					</p>
					<p>
						For those without a token, head to
						<a href="https://anilist.co/settings/developer">Anilist's Developer Page</a> and click
						&quot;Create New Client&quot;. Note the client id. Then, copy paste this URL
						<code
						...
						provide you with the token to use. You will not need to generate a token more than once.
					</p>
					<blockquote>
						<p>
							<em
					...
					<p>Once the token is accquired, then it can be added to the class as follows.</p>
					<pre
						class="prettyprint source lang-JavaScript"
...
const Anilist = new anilist(settings.token /* This being your token */);
					...
					<h2>How to Use</h2>
					<p>Every class, method, and property is found within the AniList class.</p>
					<p>
						So if the program wanted to get the character information of
						<a href="https://anilist.co/character/126156">Myne</a> from
						<a href="https://anilist.co/manga/87383">Ascendance of a Bookworm</a>, it would need to get data
						from the character method within the <a href="AniList.People.html">people</a> class.
					</p>
					<pre
						class="prettyprint source lang-JavaScript"
					><code>const AniList = require(&quot;anilist-node&quot;);
...
console.log(data);
					...
					<p>
						All of the methods to fetch data are the same way so please refer to the documentation on what
						methods are available and what data is returned in the objects.
					</p>
				</article>
			</section>
		</div>
