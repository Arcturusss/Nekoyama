...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Recommendation - AniList-Node Documentation</title>
		...
		<div id="main">
			...
			<section>
				<header>
					...
					<div class="class-description usertext">Access recommendations on AniList</div>
				</header>
				...
				<article>
					...
					<h4 class="name" id="get">
						<span class="type-signature"></span>get<span class="signature">(recommendID)</span
						><span class="type-signature">
							&rarr; {<a href="global.html#SingleRecommendation">SingleRecommendation</a>}</span
						>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Get an AniList recommendation via its ID</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="recommendation.js.html">recommendation.js</a>,
									<a href="recommendation.js.html#line51">line 51</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								<td class="name"><code>recommendID</code></td>

								<td class="type">
									<span class="param-type">Number</span>
								</td>

								<td class="description last">The AniList recommendation ID</td>
							</tr>
						</tbody>
					</table>
					...
					<dl class="param-type">
						...
						<dd>
							<span class="param-type"
								><a href="global.html#SingleRecommendation">SingleRecommendation</a></span
							>
						</dd>
					</dl>

					<h4 class="name" id="getList">
						<span class="type-signature"></span>getList<span class="signature"
							>(mediaID, page, perPage)</span
						><span class="type-signature">
							&rarr; {<a href="global.html#RecommendationList">RecommendationList</a>}</span
						>
					</h4>
					...
					<dl class="details">
						...
						<dd class="tag-description">
							<ul class="dummy">
								<li>Get AniList recommendations for a media.</li>
							</ul>
						</dd>
						...
						<dd class="tag-source">
							<ul class="dummy">
								<li>
									<a href="recommendation.js.html">recommendation.js</a>,
									<a href="recommendation.js.html#line25">line 25</a>
								</li>
							</ul>
						</dd>
					...
					<table class="params">
						...
						<tbody>
							<tr>
								...
								<td class="description last">The AniList media ID</td>
							</tr>
							...
							<tr>
								...
								<td class="description last">Target a specific page number for recommended.</td>
							</tr>
					...
					<dl class="param-type">
						...
						<dd>
							<span class="param-type"
								><a href="global.html#RecommendationList">RecommendationList</a></span
							>
						</dd>
					</dl>
				</article>
